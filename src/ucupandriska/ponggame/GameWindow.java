...
import ucupandriska.ponggame.util.GameSettings.GameMode; // Add this import
...
public class GameWindow extends JFrame implements Runnable {
    ...
    public void togglePause() {
        ...
        AudioLoader.playClip(clickClip); // Play click sound when pausing/unpausing
    ...
    public void startGame() {
        ...
        if (GameSettings.getGameMode() == GameMode.BOT) {
            ...
            playerTwoController.enableBot(ball); // Enable bot for player two
        } else {
            playerTwoController = new PlayerController(playerTwo, keyListener, Const.BIND_UP, Const.BIND_DOWN);
        }
